...
export default function () {
  ...
  return (
    <div>
      <AppBar />
      <div className="flex justify-end bg-slate-200 p-2">
        <PrimaryButton
          onClick={async () => {
      ...
      <div className="w-full h-screen bg-slate-200 flex flex-col justify-center">
        ...
        <div className="w-full pt-2 pb-2">
          {selectedActions.map((action, index) => (
            <div className="flex justify-center w-full pt-2" key={index}>
              <ZapCell
                onClick={() => {
...
function Modal({
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-sm bg-white/30 flex">
